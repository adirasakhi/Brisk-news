<div class="container">
   <div class="row">
      <div class="col">
         <h3 class="page-header">Mengatur Postingan</h3>
      </div>
   </div>
   ...
   <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="modal-title">Format artikel</h5>
         ...
         <div class="modal-body">
            <form action="#" class="form-horizontal" id="form">
               ...
               <div class="form-group row">
                  <div class="col">
                     <label for="featured" class="col-form-label">Terbaru</label>
                     <select class="form-control" id="featured" name="featured">
                        <option value="N">Tidak</option>
                        <option value="Y">Ya</option>
                     </select>
                     <small class="form-text text-danger">Rekomendasi Gambar: 1920 x 1080.</small>
                  </div>
               ...
               <div class="form-group row">
                  <label class="col-sm-2 col-form-label" id="label-photo"><span class="text-danger">*</span> Unggah Foto </label>
                  <div class="col-sm-10">
