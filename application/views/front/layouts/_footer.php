   ...
   <div class="container">
      <div class="row f_widgets_inner">
         <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-footer-widget ab_widgets">
               ...
               <p>Web Berita yang membuat semua mengetahui hal baru dengan cepat</p>
            </div>
         </div>
         <div class="col-lg-4 col-md-6 col-sm-6">
      ...
      <div class="row footer-bottom d-flex justify-content-between align-items-center">
         ...
         <p class="col-lg-8 col-md-8 footer-text"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            ...
            </script> All rights reserved | Made in <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">H A G corporation</a>
